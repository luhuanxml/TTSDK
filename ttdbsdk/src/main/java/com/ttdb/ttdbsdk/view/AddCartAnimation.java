...
public class AddCartAnimation {
     ...
     */
    public static void AddToCart(final ImageView startView, View endView, Context mContext, final RelativeLayout rl, final int time,RequestCreator requestCreator) {
